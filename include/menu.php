...
<ul class="sidebar-menu" data-widget="tree">
  <li class="header">MAIN NAVIGATION</li>
            ...
            <!-- <li><a href="?page=bayar"><i class="fa fa-money"></i>  Pembayaran Keuangan Sekolah</a></li>-->
            
          <!--  <li class="treeview <?php echo $masterb ?>">
          <a href="#">
            <i class="fa fa-wrench"></i> <span>Backup & Restore Database</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li class="<?php echo $backupaktif ?>"><a href="?page=backup"><i class="fa fa-circle-o"></i>Backup </a></li>
            <li class="<?php echo $restoreaktif ?>"><a href="?page=restore"><i class="fa fa-circle-o"></i>Restore </a></li>
