                      ...
                      <div class="modal-body">
                        ...
                        <div class="form-group">
                          ...
                          <select   class="form-control"  name="jenis_bayar">
                              ...
                              <option value="Bulanan"  <?php if ($data1['tipe_bayar']=='Bulanan'){ echo "selected";} ?>>Bulanan</option>
                              <option value="Bebas"  <?php if ($data1['tipe_bayar']=='Bebas'){ echo "selected";} ?>>Bebas</option>
