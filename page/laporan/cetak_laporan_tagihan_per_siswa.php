...
$sqlSiswa= $koneksi->query("SELECT * FROM tb_siswa, tb_kelas
			WHERE tb_siswa.id_kelas=tb_kelas.id_kelas and id_siswa='$_GET[id_siswa]' AND status='Aktif' ORDER BY nama_siswa ASC");
...
<table border="1" width="100%" class="tabel">
	...
	<tbody>
		...
		<tr>		
			...
			<td align="right"><?php echo number_format($jml_tagihan,0,",",".") ?></td>
			<td align="right"><?php echo number_format($jml_terbayar,0,",",".") ?></td>
			<td align="right" style="color: red;"><?php echo number_format($jml_sisa,0,",",".") ?></td>
   </tr>
	</tbody>
	...
	<tbody>
			...
			$sqlJenisBayar =  $koneksi->query("SELECT * from tb_jenis_bayar
				 ...
				 $data2 = $sql3->fetch_assoc();
				  ...
				  $jml_tagihan2=$jml_tagihan2+$t_tagihan2;
				$jml_terbayar2=$jml_terbayar2+$t_terbayar2;
				$jml_sisa2 = $jml_sisa2+$sisa2;
		...
		<tr>		
			<td align="center" style="font-size: 18px; font-weight: bold;" colspan="2">Total</td>
			<td align="right"><?php echo number_format($jml_tagihan2,0,",",".") ?></td>
			<td align="right"><?php echo number_format($jml_terbayar2,0,",",".") ?></td>
			<td align="right" style="color: red;"><?php echo number_format($jml_sisa2,0,",",".") ?></td>
   </tr>
	</tbody>
</table> <br><br>
