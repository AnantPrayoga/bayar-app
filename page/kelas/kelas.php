        ...
        <div class="box box-primary box-solid">
            ...
            <div class="panel-body">
              ...
              if (isset($_POST['simpan'])) {
                ...
                $sql = $koneksi->query("update  tb_kelas set nama_kelas='$nama_kelas' where id_kelas='$id_kelas_ubah'");
...
<?php 
      ...
      if (isset($_POST['tambah'])) {
        ...
        $sql = $koneksi->query("insert into tb_kelas (nama_kelas)values('$nama_kelas') ");
